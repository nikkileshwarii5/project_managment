...
const inviteProjectMember = async (req, res, next) => {
  ...
  <div style="font-family: Poppins, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9f9f9; padding: 20px; border: 1px solid #ccc; border-radius: 5px;">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDHQMmI5x5qWbOrEuJuFWkSIBQoT_fFyoKOKYqOSoIvQ&s" alt="VEXA Logo" style="display: block; margin: 0 auto; max-width: 200px; margin-bottom: 20px;">
    <h1 style="font-size: 22px; font-weight: 500; color: #854CE6; text-align: center; margin-bottom: 30px;">Invitation to join a VEXA Project</h1>
    <div style="background-color: #FFF; border: 1px solid #e5e5e5; border-radius: 5px; box-shadow: 0px 3px 6px rgba(0,0,0,0.1); padding: 20px;">
      <p style="font-size: 16px; line-height: 1.6; color: #333;">Hello,</p>
      <p style="font-size: 16px; line-height: 1.6; color: #333;">You have been invited to join the project <strong style="color: #854CE6;">${project.name}</strong> as a <strong style="color: #854CE6;">${req.body.role}</strong>. Your access level will be <strong style="color: #854CE6;">${req.body.access}</strong>.</p>
      <p style="font-size: 16px; line-height: 1.6; color: #333;">Please click on the button below to accept the invitation and join the project:</p>
      <a href="${link}" style="display: block; width: 200px; margin: 20px auto; background-color: #854CE6; color: #FFF; text-align: center; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">Join Project</a>
      <p style="font-size: 16px; line-height: 1.6; color: #333;">If the button above does not work, please copy and paste the following link into your web browser:</p>
      <p style="font-size: 16px; line-height: 1.6; color: #854CE6; word-wrap: break-word;">${link}</p>
    </div>
    <p style="font-size: 14px; line-height: 1.6; color: #666; text-align: center; margin-top: 30px;">Thank you for using VEXA!</p>
  </div>
  `;
  const mailOptions = {
    from: process.env.EMAIL_USERNAME,
    to: req.body.email,
    subject: 'Invitation to join VEXA Project',
    html: mailBody
  };
  ...
  res.status(200).json({ message: "Invitation has been sent to " + req.body.email });
};
